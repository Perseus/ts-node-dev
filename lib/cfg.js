...
exports.makeCfg = function (main, opts) {
    ...
    var restartOnlyForItems = [];
    if (opts.config) {
        var fileContent = fs_1.default.readFileSync(opts.config).toString();
        var config = JSON.parse(fileContent);
        if (config.restartForFiles && Array.isArray(config.restartForFiles)) {
            restartOnlyForItems.push.apply(restartOnlyForItems, config.restartForFiles);
